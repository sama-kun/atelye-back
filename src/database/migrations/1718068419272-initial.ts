...
export class Initial1718068419272 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "products" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "isDeleted" boolean NOT NULL DEFAULT false, "orderDate" date NOT NULL, "receptionDate" date NOT NULL, "amount" integer NOT NULL, "money" numeric(10,2) NOT NULL, "categoryId" integer, CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "huetas" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "isDeleted" boolean NOT NULL DEFAULT false, "quantity" integer NOT NULL, "length" double precision, "width" double precision, "description" character varying, "serviceId" integer, "materialId" integer, "orderId" integer, CONSTRAINT "PK_39a14b61fdb9cee269e0f78604c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."orders_status_enum" AS ENUM('done', 'todo', 'inProcess')`,
    );
    await queryRunner.query(
      `CREATE TABLE "orders" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "isDeleted" boolean NOT NULL DEFAULT false, "name" character varying NOT NULL, "surname" character varying NOT NULL, "phone" character varying NOT NULL, "startDate" TIMESTAMP, "deadline" TIMESTAMP, "amount" numeric, "status" "public"."orders_status_enum" NOT NULL DEFAULT 'inProcess', "employeeId" integer, CONSTRAINT "PK_710e2d4957aa5878dfe94e4ac2f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "materials" ADD CONSTRAINT "FK_80b45bfb4aea111a6242d07d830" FOREIGN KEY ("providerId") REFERENCES "providers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "huetas" ADD CONSTRAINT "FK_b6a44afad33318a4c9004e360c8" FOREIGN KEY ("serviceId") REFERENCES "services"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "huetas" ADD CONSTRAINT "FK_6070eaa43ee68f75b23bf240318" FOREIGN KEY ("materialId") REFERENCES "materials"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "huetas" ADD CONSTRAINT "FK_c1cdf9af0bb0b33939121a3ab2f" FOREIGN KEY ("orderId") REFERENCES "orders"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "huetas" DROP CONSTRAINT "FK_c1cdf9af0bb0b33939121a3ab2f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "huetas" DROP CONSTRAINT "FK_6070eaa43ee68f75b23bf240318"`,
    );
    await queryRunner.query(
      `ALTER TABLE "huetas" DROP CONSTRAINT "FK_b6a44afad33318a4c9004e360c8"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "materials" DROP CONSTRAINT "FK_80b45bfb4aea111a6242d07d830"`,
    );
    ...
    await queryRunner.query(`DROP TABLE "huetas"`);
